...
//        let tileLayer = tilemap.getLayers()[0]
//        // convert a position in the current view to a scene position
//        let positionInScene = view!.convert(location, to: scene!)
...
//        for tile in allTilesForCoord {
//            tile.highlightDuration = 3
